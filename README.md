...
Cada bloque de código se puede ejecutar directamente haciendo clic en el botón **Run** (▶️) que aparece en la vista previa.
...
| Booleano | `bool` | `bool` |
| Nulo | `None` | Zero value (`""`, `0`, `false`, `nil`) |

---

¡Ejecuta cada bloque con el botón **Run** y experimenta modificando los valores!